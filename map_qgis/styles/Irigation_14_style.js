...
var style_Irigation_14 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("irigasi_nilai air (%)");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 30.000000) {
        ...
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(253,254,255,1.0)'}),
